...
<div class="mx-4">
    <x-card class="!p-10">
            ...
            <div>
                ...
                <div class="text-lg space-y-6">
                    ...
                    <a href="{{$listing->website}}" target="_blank" class="block bg-black text-white py-2 rounded-xl hover:opacity-80">
                        <i class="fa-solid fa-globe"></i> Employer's Website</a>
        ...
        {{-- <x-card>
            <a href="/listings/{{$listing->id}}/edit" target="_self" class="block bg-black text-white py-2 mt-6 rounded-xl hover:opacity-80">
                <i class="fa-solid fa-pencil"></i> Edit Listing </a>
            <form action="/listings/{{$listing->id}}" method="post">
                @csrf 
                @method('DELETE')
    
            <button class="block bg-white text-red-500 py-2 rounded-xl hover:opacity-80">
                <i class="fa-solid fa-trash"></i> Delete Listing </button>
